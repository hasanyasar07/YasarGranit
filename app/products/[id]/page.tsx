  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-6 md:py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
        {/* Ürün resmi */}
        <div className="relative h-72 sm:h-96 md:h-[520px] bg-gray-50 rounded-2xl overflow-hidden border border-gray-100">
          <Image
        ...
        <div className="flex flex-col justify-center gap-4">
          ...
          {settings?.whatsappNumber && (
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold px-6 py-4 rounded-xl transition-colors text-sm w-full shadow-sm shadow-green-200"
            >
